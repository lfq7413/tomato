...
func TestPostgres_Execute_Write(t *testing.T) {
	var className string
	var w *Write
	var auth *Auth
	var query types.M
...
func TestPostgres_validateSchema(t *testing.T) {
	// 测试用例与 DBController.ValidateObject 相同
}

func TestPostgres_handleInstallation(t *testing.T) {
...
func TestPostgres_setRequiredFieldsIfNeeded(t *testing.T) {
	var w *Write
	var query types.M
	var data types.M
	var originalData types.M
...
func TestPostgres_transformUser(t *testing.T) {
	var schema, object types.M
	var w *Write
	var query types.M
	var data types.M
...
func TestPostgres_runDatabaseOperation(t *testing.T) {
	var schema, object types.M
	var w *Write
	var className string
	var auth *Auth
...
func TestPostgres_handleFollowup(t *testing.T) {
	var schema, object types.M
	var className string
	var w *Write
	var query types.M
...
func TestPostgres_cleanUserAuthData(t *testing.T) {
	var w *Write
	var expect types.M
	/***************************************************************/
...
func TestPostgres_handleAuthData(t *testing.T) {
	var className string
	var schema types.M
	var object types.M
	var w *Write
...
func TestPostgres_findUsersWithAuthData(t *testing.T) {
	var schema types.M
	var object types.M
	var w *Write
	var query types.M
...
func TestPostgres_objectID(t *testing.T) {
	var w *Write
	var query types.M
	var data types.M
	var originalData types.M
...
func TestPostgres_sanitizedData(t *testing.T) {
	var w *Write
	var query types.M
	var data types.M
	var originalData types.M
...
func TestPostgres_updateResponseWithData(t *testing.T) {
	var w *Write
	var query types.M
	var data types.M
	var originalData types.M
